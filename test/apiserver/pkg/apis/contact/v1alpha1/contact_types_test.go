...
import (
	...
	. "github.com/infobloxopen/konk/test/apiserver/pkg/client/clientset_generated/clientset/typed/contact/v1alpha1"
)
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ContactV1alpha1().Contacts("contact-test-valid")
