...
var (
	ApiVersion = builders.NewApiVersion("contact.example.infoblox.com", "v1alpha1").WithResources(
		contact.ContactContactStorage,
		builders.NewApiResource( // Resource status endpoint
			contact.InternalContactStatus,
			...
			&contact.ContactStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
		))
