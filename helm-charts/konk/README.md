...
| ingress.tls | list | `[]` |  |
| kind | object | `{"image":{"pullPolicy":"IfNotPresent","repository":"infoblox/konk-tools","tag":""},"resources":{"limits":{"memory":"256Mi"},"requests":{"cpu":"10m","memory":"32Mi"}},"securityContext":{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsNonRoot":true}}` | konk-tools image used for test pods (contains kubectl + busybox shell) |
